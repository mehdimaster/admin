    ...
    if ($('body').data('page') == 'login') {
        ...
        $('#submit-form').click(function(e) {
            form.validate({
                ...
                messages: {
                    username: {
                        ...
                        minlength: jQuery.format("حداقل می بایست {0} حرف وارد کنید"),
                    },
                    password: {
                        required: 'پسورد خود را وارد کنید',
                        minlength: jQuery.format("حداقل می بایست {0} حرف وارد کنید"),
                        maxlength: jQuery.format("حداکثر می بایست {0} حرف وارد کنید"),
            ...
            if (form.valid()) {
                ...
                l.start();
                $.ajax({
                    url: "http://localhost/sahand/public/admin/login",
                    type: "POST",
                    data: form.serialize(),
                    success: function(result){
                        if(result.status){
                            window.location.href = "http://localhost/sahand/public/admin/dashboard";
                        }else{
                            $('body').addClass('boxed');
                            $(".error-user").show();
        ...
        $.backstretch(["../../../assets/img/admin/gallery/login4.jpg", "../../../assets/img/admin/gallery/login3.jpg", "../../../assets/img/admin/gallery/login2.jpg", "../../../assets/img/admin/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
        ...
        $('#image-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["../../../assets/img/admin/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
